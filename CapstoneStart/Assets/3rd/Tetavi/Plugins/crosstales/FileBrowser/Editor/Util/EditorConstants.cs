...
namespace Crosstales.FB.EditorUtil
{
   ...
   public static class EditorConstants
   {
      ...
      public const string KEY_MACOS_MODIFY_BUNDLE = Util.Constants.KEY_PREFIX + "MACOS_MODIFY_BUNDLE";
      public const string KEY_WSA_MODIFY_MANIFEST = Util.Constants.KEY_PREFIX + "WSA_MODIFY_MANIFEST";
      ...
      public const bool DEFAULT_WSA_MODIFY_MANIFEST = true;
