...
namespace Crosstales.FB.EditorUtil
{
   ...
   public static class EditorConfig
   {
      ...
      public static bool MACOS_MODIFY_BUNDLE = EditorConstants.DEFAULT_MACOS_MODIFY_BUNDLE;

      /// <summary>Enable or disable the modifications of the Package.appxmanifest under UWP (WSA).</summary>
      public static bool WSA_MODIFY_MANIFEST = EditorConstants.DEFAULT_WSA_MODIFY_MANIFEST;
      ...
      public static void Reset()
      {
         ...
         MACOS_MODIFY_BUNDLE = EditorConstants.DEFAULT_MACOS_MODIFY_BUNDLE;
         WSA_MODIFY_MANIFEST = EditorConstants.DEFAULT_WSA_MODIFY_MANIFEST;
      }
      ...
      public static void Load()
      {
         ...
         if (Common.Util.CTPlayerPrefs.HasKey(EditorConstants.KEY_MACOS_MODIFY_BUNDLE))
            MACOS_MODIFY_BUNDLE = Common.Util.CTPlayerPrefs.GetBool(EditorConstants.KEY_MACOS_MODIFY_BUNDLE);

         if (Common.Util.CTPlayerPrefs.HasKey(EditorConstants.KEY_WSA_MODIFY_MANIFEST))
            WSA_MODIFY_MANIFEST = Common.Util.CTPlayerPrefs.GetBool(EditorConstants.KEY_WSA_MODIFY_MANIFEST);
      ...
      public static void Save()
      {
         ...
         Common.Util.CTPlayerPrefs.SetBool(EditorConstants.KEY_MACOS_MODIFY_BUNDLE, MACOS_MODIFY_BUNDLE);
         Common.Util.CTPlayerPrefs.SetBool(EditorConstants.KEY_WSA_MODIFY_MANIFEST, WSA_MODIFY_MANIFEST);
