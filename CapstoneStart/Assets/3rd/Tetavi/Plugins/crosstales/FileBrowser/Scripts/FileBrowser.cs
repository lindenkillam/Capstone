   ...
   public class FileBrowser : Crosstales.Common.Util.Singleton<FileBrowser>
   {
      ...
      public void OpenSingleFileAsync(string title, string directory, string defaultName, params ExtensionFilter[] extensions)
      {
         ...
         if (canOpenFile)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenFilesAsync(string.IsNullOrEmpty(title) ? titleOpenFile : title, Crosstales.Common.Util.FileHelper.ValidatePath(directory, true, false), defaultName, false, extensions, setOpenFiles);
         }
         else
         {
      ...
      public void OpenFilesAsync(string title, string directory, string defaultName, bool multiselect = true, params ExtensionFilter[] extensions)
      {
         ...
         if (canOpenFile)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenFilesAsync(string.IsNullOrEmpty(title) ? multiselect ? titleOpenFiles : titleOpenFile : title, Crosstales.Common.Util.FileHelper.ValidatePath(directory, true, false), defaultName, multiselect, extensions, setOpenFiles);
         }
         else
         {
      ...
      public void OpenSingleFolderAsync(string title, string directory = "")
      {
         ...
         if (canOpenFolder)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenFoldersAsync(string.IsNullOrEmpty(title) ? titleOpenFolder : title, Crosstales.Common.Util.FileHelper.ValidatePath(directory, true, false), false, setOpenFolders);
         }
         else
         {
      ...
      public void OpenFoldersAsync(string title, string directory = "", bool multiselect = true)
      {
         ...
         if (canOpenFolder)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenFoldersAsync(string.IsNullOrEmpty(title) ? multiselect ? titleOpenFolders : titleOpenFolder : title, Crosstales.Common.Util.FileHelper.ValidatePath(directory, true, false), multiselect, setOpenFolders);
         }
         else
         {
      ...
      public void SaveFileAsync(string title, string directory, string defaultName, params ExtensionFilter[] extensions)
      {
         ...
         if (canSaveFile)
         {
            ...
            wrapperHolder.PlatformWrapper.SaveFileAsync(string.IsNullOrEmpty(title) ? titleSaveFile : title, Crosstales.Common.Util.FileHelper.ValidatePath(directory, true, false), string.IsNullOrEmpty(defaultName) ? NameSaveFile : defaultName, extensions, paths => setSaveFile(paths));
         }
         else
         {
