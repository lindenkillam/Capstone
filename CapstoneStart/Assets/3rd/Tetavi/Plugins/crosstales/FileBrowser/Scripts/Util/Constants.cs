namespace Crosstales.FB.Util
{
   ...
   public abstract class Constants : Common.Util.BaseConstants
   {
      ...
      public const string ASSET_VERSION = "2021.3.6";

      /// <summary>Build number of the asset.</summary>
      public const int ASSET_BUILD = 20211229;
      ...
      public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2021, 12, 29);
