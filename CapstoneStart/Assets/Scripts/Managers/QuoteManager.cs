...
public class QuoteManager : MonoBehaviour
{
    ...
    public string[] SadBoiQuotes = {"Why haven't they come back...", "Why is the Institute programming failing me...",
        ...
        "My previous life was useful, right?", "Did I do good, Mr. Hoffman?", "I'll do better in the next life cycle, I promise...",
        "I don't understand, where does all the money go?", "I was examined so much, but never made Ascended?!"};
}